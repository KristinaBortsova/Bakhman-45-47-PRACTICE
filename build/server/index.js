...
function Header() {
  return /* @__PURE__ */ jsx("header", { className: "bg-emerald-800 text-white shadow-lg", children: /* @__PURE__ */ jsxs("nav", { className: "container mx-auto px-4 py-4 max-w-6xl flex justify-between items-center", children: [
    /* @__PURE__ */ jsx(Link, { to: "/", className: "text-2xl font-bold hover:text-emerald-300 transition-colors", children: "Эль Камино" }),
    /* @__PURE__ */ jsxs("div", { className: "flex gap-6", children: [
      /* @__PURE__ */ jsx(
        NavLink,
        {
          to: "/",
          className: ({ isActive }) => isActive ? "text-emerald-300 font-medium" : "hover:text-emerald-300 transition-colors",
          children: "Главная"
        }
      ),
      /* @__PURE__ */ jsx(
...
const restaurantInfo = {
  name: "Эль Камино",
  description: "Аутентичный мексиканский ресторан с домашней атмосферой. Острые соусы, сочное мясо, текила и сомбреро ждут вас!",
  address: "г. Новосибирск, ул. советская, д. 83",
  phone: "+7 (495) 777-67-66",
  hours: "Ежедневно с 14:00 до 01:00"
};
function Footer() {
  return /* @__PURE__ */ jsx("footer", { className: "bg-stone-800 text-stone-300 py-8 mt-auto", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 max-w-6xl", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "text-center text-xs text-stone-400 mt-6 pt-4 border-t border-stone-700", children: [
      "© 2024 ",
      restaurantInfo.name,
      ". Все права защищены. ¡Bienvenidos!"
    ] })
  ] }) });
}
const links = () => [];
  ...
  if (items.length === 0) {
    return /* @__PURE__ */ jsxs("div", {
      ...
      children: [/* @__PURE__ */ jsx("h1", {
        ...
        children: "Ваша корзина пуста... но это легко исправить! 🌮"
      }), /* @__PURE__ */ jsx(Link, {
        to: "/menu",
  ...
  return /* @__PURE__ */ jsxs("div", {
    ...
    children: [/* @__PURE__ */ jsxs("div", {
      ...
      children: [/* @__PURE__ */ jsx("div", {
        ...
        children: '🎸 Фотография ресторана "Эль Камино"'
      }), /* @__PURE__ */ jsx("p", {
